          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-timberwolf bg-hunter-green/80 border border-hunter-green rounded-lg hover:bg-hunter-green focus:outline-none focus:ring-2 focus:ring-sinopia transition-all duration-200"
              >
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  readOnly
                />
                <button className="absolute right-2 top-2 w-10 h-10 flex items-center justify-center hover:bg-golden-brown/20 rounded-lg transition-colors text-eerie-black">
